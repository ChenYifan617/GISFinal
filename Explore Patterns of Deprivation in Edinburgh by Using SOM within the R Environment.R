...
data <- read_csv(file="https://github.com/ChenYifan617/GISFinal/blob/main/SIMD2020.csv")
...
edinburgh_map <- readOGR(dsn="https://github.com/ChenYifan617/GISFinal/blob/main/Edinburgh.shp", layer="Edinburgh")
#since r cannot read shapefiles from the github link, I zipped all the file and put them into my github. 
#you can download the zip file from the link below or from mygithub:
#https://raw.githubusercontent.com/ChenYifan617/GISFinal/main/data.zip
